...
using Inventory.DAL.Migrations;
using System;
 ...
 */
namespace InventoryTrackingAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<InventoryDbcontext>(options => options.UseNpgsql(connectionStr));
            ...
            services.AddTransient<OrderLineItemService, OrderLineItemService>();
            services.AddTransient<IOrderRepo, OrderRepo>();
            services.AddTransient<IProductRepo,ProductRepo>();
            services.AddTransient<IPurchaseLineRepo,PurchaseLineRepo>();
            services.AddTransient<ISalesOrderLineRepo,SalesOrderLineRepo>();
            services.AddTransient<ISupplierRepo,ISupplierRepo>();
            services.AddTransient<IOrderLineRepository, OrderLineRepository>();
            services.AddTransient<ISalesOrderRepo,SalesOrderRepo>();
